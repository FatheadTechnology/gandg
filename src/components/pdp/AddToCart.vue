<template>
  <div class="add-to-cart" id="add-to-cart-btn">
    <div v-on:click="addToCartHere(product).then(showModal())" class="btn" :id="`add-to-cart-${product.SkuNumber}`">
      ADD TO CART
    </div>
...
import AddToCartModal from "../global/AddToCartModal";
